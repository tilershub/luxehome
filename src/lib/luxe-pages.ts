...
export const PROJECT_INITIATION_FAQ: Array<{ title: string; copy: string }> = [
  ...
  },
  {
    ...
    copy: 'The proposal records the approved materials, brands, scope, construction process, quality commitments and applicable warranty periods. During construction, critical stages such as plumbing pressure testing, waterproofing, flood testing, tile installation and final inspection are checked before handover. The applicable warranty record is issued with the completed project.',
  },
];
...
export const PUBLIC_INFO_PAGES: PublicInfoPage[] = [
  ...
  { slug:'warranty-aftercare', eyebrow:'Warranty & aftercare', title:'Our responsibility continues after handover.', lead:'Warranty is given against each part of the work, not as one blanket period, and is recorded with your project at handover — subject to the agreed scope and terms.', cards:[{title:'Warranty by task',copy:'Bathware 15 years · Waterproofing 10 years · Plumbing 10 years · Wiring 10 years · Taps & showers 5 years · Ceiling 5 years · Light fixtures 1 year · Tempered glass 1 year.'},{title:'At handover',copy:'Testing, client walkthrough, care guidance and the written warranty record.'},{title:'If something goes wrong',copy:'Send the project reference, photos and a clear description through WhatsApp.'},{title:'Our response',copy:'We assess coverage, arrange inspection when necessary and document the resolution.'}] },
